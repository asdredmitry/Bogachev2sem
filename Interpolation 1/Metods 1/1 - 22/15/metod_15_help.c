...
int Init_15(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_15(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_15(void)
{
	Coeff_15(n, x, f_x, c, d, a1, b1);
}

double f_15(double t)
{
	return Value_15(t, n, c, x);
}
