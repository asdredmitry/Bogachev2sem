...
int Init_25(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_25(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_25(void)
{
	Coeff_25(n, x, f_x, c, d);
}

double f_25(double t)
{
	return Value_25(t, n, c, x);
}
