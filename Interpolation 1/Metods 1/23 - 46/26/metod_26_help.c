...
int Init_26(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_26(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_26(void)
{
	Coeff_26(n, x, f_x, c, d, a1, b1);
}

double f_26(double t)
{
	return Value_26(t, n, c, x);
}
