...
void Coeff_32(int n, double *x, double *f_x, double *c, double *d, double *a1, double *b1);
double Value_32(double t, int n, double *c, double *x);

int Init_32(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_32(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_32(void)
{
	Coeff_32(n, x, f_x, c, d, a1, b1);
}

double f_32(double t)
{
	return Value_32(t, n, c, x);
}
