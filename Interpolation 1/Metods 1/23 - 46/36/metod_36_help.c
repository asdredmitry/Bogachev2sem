...
void Coeff_36(int n, double *x, double *f_x, double *c, double *d, double *a1, double *c1, double *d1);
double Value_36(double t, int n, double *c, double *x);

int Init_36(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_36(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_36(void)
{
	Coeff_36(n, x, f_x, c, d, a1, c1, d1);
}

double f_36(double t)
{
	return Value_36(t, n, c, x);
}
