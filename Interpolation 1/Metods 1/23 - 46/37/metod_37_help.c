...
int Init_37(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_37(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_37(void)
{
	Coeff_37(n, x, f_x, c, d, a1, c1, d1);
}

double f_37(double t)
{
	return Value_37(t, n, c, x);
}
