...
int Init_38(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_38(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_38(void)
{
	Coeff_38(n, x, f_x, c, d, a1, c1, d1);
}

double f_38(double t)
{
	return Value_38(t, n, c, x);
}
