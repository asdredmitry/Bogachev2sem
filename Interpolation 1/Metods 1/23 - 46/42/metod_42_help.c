...
int Init_42(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_42(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_42(void)
{
	Coeff_42(n, a, b, x, f_x, c, v, ksi, a1, c1, d1);
}

double f_42(double t)
{
	return Value_42(t, n, c, ksi);
}
