...
int Init_43(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_43(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_43(void)
{
	Coeff_43(n, a, b, x, f_x, c, v, ksi, a1, c1, d1);
}

double f_43(double t)
{
	return Value_43(t, n, c, ksi);
}
