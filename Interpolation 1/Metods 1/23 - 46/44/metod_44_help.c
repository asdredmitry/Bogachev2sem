...
int Init_44(int n_, double a_, double b_)
{
	n = n_;
	a = a_;
	b = b_;
...
void Delta_44(int number, double delta)
{
	f_x[number] += delta;
}
...
void Calc_44(void)
{
	Coeff_44(n, a, b, x, f_x, c, v, ksi, a1, c1, d1);
}

double f_44(double t)
{
	return Value_44(t, n, c, ksi);
}
